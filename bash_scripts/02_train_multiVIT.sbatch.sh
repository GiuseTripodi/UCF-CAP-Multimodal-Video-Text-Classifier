...
usage() {
    echo "Usage: $0 [--config <config_path>] [--save_dir <save_dir>] [--name <model_name>]"
    exit 1
}
...
python3 "${PROJECT_ROOT}/src/multi_vit/train_multi_vit.py" --config="$CONFIG" --save_dir="$SAVE_DIR" --name="$NAME"
