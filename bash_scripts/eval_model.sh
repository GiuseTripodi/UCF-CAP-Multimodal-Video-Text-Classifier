...
DEFAULT_DATA="/mnt/iusers01/mace01/t08341gt/UCF_cap_mh/data/UcfCap/test_dataset.csv"
DEFAULT_LOG="/mnt/iusers01/mace01/t08341gt/UCF_cap_mh/data/logs"
DEFAULT_MODEL_PATH="/mnt/iusers01/mace01/t08341gt/UCF_cap_mh/data/models"
DEFAULT_NAME="test"
...
python3 /mnt/iusers01/mace01/t08341gt/UCF_cap_mh/eval.py  --data="$DATA" --model_path="$MODEL_PATH" --log="$LOG" --name="$NAME"
