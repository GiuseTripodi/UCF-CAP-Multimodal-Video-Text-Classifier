...
def load_dataset(config):
    ...
    dataset_train = UCF101Dataset(csv_train_file_path, sampling_method='interpolate', num_frames=32)
    dataset_val = UCF101Dataset(csv_val_file_path, sampling_method='interpolate', num_frames=32)
